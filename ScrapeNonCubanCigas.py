...
url = "http://cigarinspector.com/index-of-all-non-cuban-cigar-reviews"
page = urllib2.urlopen(url)
soup = BeautifulSoup(page.read())
list = soup.find("div", {"class":"post-page-content"})

htmlToAppendNonCubanDic = []
data = {}
names = []
number = 0
LinkList = []
...
for link in LinkList: #back to 2
    ...
    if cContent != None :
        ...
        htmlToAppendNonCubanDic.append(cigLink)
    print 'done..'        
        
NoncubanCigar = data

with open('NonCubanCigar.json', 'w') as fp:
     json.dump(data, fp)
fp.close()
